...
INSERT INTO products (category_id, reference, type, brand, model, image_source, image_alt, price, quantity, available, description, reference_month, reference_year, color) VALUES
    ...
    (1, '0002','Guitars', 'Bender', 'Telemaster M-102', '/src/assets/catalogue/products/guitars/bender-telemaster%20m102.jpg', 
    ...
    (1, '0003', 'Guitars', 'Gibbons', 'Lep Saul', '/src/assets/catalogue/products/guitars/gibbons-lep%20saul.jpg', 
    ...
    (1, '0004', 'Guitars', 'Gibbons', 'Melody Faker', '/src/assets/catalogue/products/guitars/gibbons-melody%20faker.jpg', 
    ...
    (1, '0005', 'Guitars', 'Greta', 'Lucilla', '/src/assets/catalogue/products/guitars/greta-lucilla.jpg', 
    ...
    (1, '0006', 'Guitars', 'Schelter', 'GMK Signature', '/src/assets/catalogue/products/guitars/schelter-gmk%20signature.jpg', 
    'Schelter GMK Signature', '1499.00', 0, false, 
    'Unconventional and bold, the Melody Faker yields unique soundscapes perfect for experimental musicians.', 
    'July', '2021', 'Purple, Black'),
    
    (2, '1001','Basses', 'Bender', 'Decision J37', '/src/assets/catalogue/products/basses/bender%20decision%20j37.jpg', 
    ...
    (2, '1002', 'Basses', 'Ivarez', 'Blizzard', '/src/assets/catalogue/products/basses/ivarez%20blizzard.jpg', 
    ...
    (2, '1003', 'Basses', 'Kickenbacker', 'Paul MyCourtney', '/src/assets/catalogue/products/basses/kickenbacker%20paul%20mycourtney.jpg', 
    ...
    (2, '1004', 'Basses', 'Epiklone', 'Marcus Thriller', '/src/assets/catalogue/products/basses/epiklone-marcus-thriller.jpg', 
    ...
    (2, '1005', 'Basses', 'Ivarez', 'Thunder', '/src/assets/catalogue/products/basses/ivarez-thunder.jpg', 
    ...
    (2, '1006', 'Basses', 'Ivarez', 'Hurricane', '/src/assets/catalogue/products/basses/ivarez-hurricane.jpg', 
    ...
    (3, '2001', 'Acoustic', 'Bender', 'Arizona', '/src/assets/catalogue/products/acoustic/bender-arizona.jpg', 
    ...
    (3, '2002', 'Acoustic', 'Matakine', 'Velvet', '/src/assets/catalogue/products/acoustic/matakine-velvet.jpg', 
    ...
    (3, '2003', 'Acoustic', 'Saylor', 'Girlstar', '/src/assets/catalogue/products/acoustic/saylor%20girlstar.jpg', 
    ...
    (3, '2004', 'Acoustic', 'Rainbow', 'UkukukuLele', '/src/assets/catalogue/products/acoustic/rainbow-ukukukulele.jpg', 
    ...
    (3, '2005', 'Acoustic', 'Bender', 'BlackyFolk', '/src/assets/catalogue/products/acoustic/bender-blackyfolk.jpg', 
    ...
    (3, '2006', 'Acoustic', 'Matakine', 'Nature Revenge', '/src/assets/catalogue/products/acoustic/matakine-nature-revenge.jpg', 
    'Matakine Nature Revenge', '1749.00', 5, true, 
    'Embrace the spirit of the Southwest with the Arizona''s resonant tones and intricate inlays, a tribute to acoustic beauty.', 
    'July', '2017', 'Classic wood'),
    
    (4, '3001', 'Amps', 'Leavey', 'HSR9902', '/src/assets/catalogue/products/amps/leavey-hsr9902.jpg', 
    ...
    (4, '3002', 'Amps', 'Marshiall', 'Headbanger', '/src/assets/catalogue/products/amps/marshiall-headbanger.jpg', 
    ...
    (4, '3003', 'Amps', 'Vex', 'Vortex 222', '/src/assets/catalogue/products/amps/vex-vortex222.jpg', 
    ...
    (4, '3004', 'Amps', 'Masta Braggie', 'Brag'' 469', '/src/assets/catalogue/products/amps/masta-braggie-brag-469.jpg', 
    ...
    (4, '3005', 'Amps', 'Yellow', 'HoneyMoon', '/src/assets/catalogue/products/amps/yellow-honeymoon.jpg', 
    ...
    (4, '3006', 'Amps', 'Pinkstar', 'V7', '/src/assets/catalogue/products/amps/pinkstar-v7.jpg', 
    ...
    (5, '4001', 'Synths', 'Borg', 'MT20', '/src/assets/catalogue/products/synth/borg-mt20.jpg', 
    ...
    (5, '4002', 'Synths', 'Romand', 'Juny 70', '/src/assets/catalogue/products/synth/romand-juny70.jpg', 
    ...
    (5, '4003', 'Synths', 'Voog', 'Uzi 16', '/src/assets/catalogue/products/synth/Voog%20Uzi%2016.jpg', 
    ...
    (5, '4004', 'Synths', 'Masturia', 'Ivy 1236', '/src/assets/catalogue/products/synth/masturia-ivy-1236.jpg', 
    ...
    (5, '4005', 'Synths', 'D''Angelica', 'Movoder Disco 73', '/src/assets/catalogue/products/synth/d''angelica-movoder-disco-73.jpg', 
    ...
    (5, '4006', 'Synths', 'LoveNation', 'Vitto 6', '/src/assets/catalogue/products/synth/lovenation-vitto6.jpg', 
    ...
    (6, '5001', 'Drums', 'Connor', 'DevilKit', '/src/assets/catalogue/products/drums/connor%20devilkit.jpg', 
    ...
    (6, '5002', 'Drums', 'Diamond', 'Manchester', '/src/assets/catalogue/products/drums/diamond%20manchester.jpg', 
    ...
    (6, '5003', 'Drums', 'Tamaha', 'DK707', '/src/assets/catalogue/products/drums/tamaha%20dk707.jpg', 
    ...
    (6, '5004', 'Drums', 'Orage Country', 'TB Signature', '/src/assets/catalogue/products/drums/Orage-Country-tb-signature.jpg', 
    ...
    (6, '5005', 'Drums', 'Connor', 'Jungle Dynamite', '/src/assets/catalogue/products/drums/connor-jungle-dynamite.jpg', 
    ...
    (6, '5006', 'Drums', 'Tamaha', 'Iceberg', '/src/assets/catalogue/products/drums/tamaha-iceberg.jpg', 
