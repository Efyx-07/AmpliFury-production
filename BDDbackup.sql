...
INSERT INTO Products (category_id, type, brand, model, image_source, image_alt, price, quantity, available, description, reference_month, reference_year, color) VALUES
	(1, 'Guitar', 'Bender', 'Telemaster M-101', '/src/assets/catalogue/products/guitars/bender-telemaster%20m101.jpg', 
    ...
    (1, 'Guitar', 'Bender', 'Telemaster M-102', '/src/assets/catalogue/products/guitars/bender-telemaster%20m102.jpg', 
    ...
    (1, 'Guitar', 'Gibbons', 'Lep Saul', '/src/assets/catalogue/products/guitars/gibbons-lep%20saul.jpg', 
    ...
    (1, 'Guitar', 'Gibbons', 'Melody Faker', '/src/assets/catalogue/products/guitars/gibbons-melody%20faker.jpg', 
    ...
    (1, 'Guitar', 'Greta', 'Lucilla', '/src/assets/catalogue/products/guitars/greta-lucilla.jpg', 
    ...
    (1, 'Guitar', 'Schelter', 'GMK Signature', '/src/assets/catalogue/products/guitars/schelter-gmk%20signature.jpg', 
    'Schelter GMK Signature', '1499.00', 0, false, 
    'Unconventional and bold, the Melody Faker yields unique soundscapes perfect for experimental musicians.', 
    'July', '2021', 'Purple, Black'),
    
    (2, 'Bass', 'Bender', 'Decision J37', '/src/assets/catalogue/products/basses/bender%20decision%20j37.jpg', 
    ...
    (2, 'Bass', 'Ivarez', 'Blizzard', '/src/assets/catalogue/products/basses/ivarez%20blizzard.jpg', 
    ...
    (2, 'Bass', 'Kickenbacker', 'Paul MyCourtney', '/src/assets/catalogue/products/basses/kickenbacker%20paul%20mycourtney.jpg', 
    ...
    (2, 'Bass', 'Epiklone', 'Marcus Thriller', '/src/assets/catalogue/products/basses/epiklone-marcus-thriller.jpg', 
    ...
    (2, 'Bass', 'Ivarez', 'Thunder', '/src/assets/catalogue/products/basses/ivarez-thunder.jpg', 
    ...
    (2, 'Bass', 'Ivarez', 'Hurricane', '/src/assets/catalogue/products/basses/ivarez-hurricane.jpg', 
    ...
    (3, 'Acoustic guitar', 'Bender', 'Arizona', '/src/assets/catalogue/products/acoustic/bender-arizona.jpg', 
    ...
    (3, 'Acoustic guitar', 'Matakine', 'Velvet', '/src/assets/catalogue/products/acoustic/matakine-velvet.jpg', 
    ...
    (3, 'Acoustic guitar', 'Saylor', 'Girlstar', '/src/assets/catalogue/products/acoustic/saylor%20girlstar.jpg', 
    ...
    (3, 'Acoustic ukulele', 'Rainbow', 'UkukukuLele', '/src/assets/catalogue/products/acoustic/rainbow-ukukukulele.jpg', 
    ...
    (3, 'Acoustic guitar', 'Bender', 'BlackyFolk', '/src/assets/catalogue/products/acoustic/bender-blackyfolk.jpg', 
    ...
    (3, 'Acoustic guitar', 'Matakine', 'Nature Revenge', '/src/assets/catalogue/products/acoustic/matakine-nature-revenge.jpg', 
    'Matakine Nature Revenge', '1749.00', 5, true, 
    'Embrace the spirit of the Southwest with the Arizona''s resonant tones and intricate inlays, a tribute to acoustic beauty.', 
    'July', '2017', 'Classic wood'),
    
    (4, 'Amp', 'Leavey', 'HSR9902', '/src/assets/catalogue/products/amps/leavey-hsr9902.jpg', 
    ...
    (4, 'Amp', 'Marshiall', 'Headbanger', '/src/assets/catalogue/products/amps/marshiall-headbanger.jpg', 
    ...
    (4, 'Amp', 'Vex', 'Vortex 222', '/src/assets/catalogue/products/amps/vex-vortex222.jpg', 
    ...
    (4, 'Amp', 'Masta Braggie', 'Brag'' 469', '/src/assets/catalogue/products/amps/masta-braggie-brag-469.jpg', 
    ...
    (4, 'Amp', 'Yellow', 'HoneyMoon', '/src/assets/catalogue/products/amps/yellow-honeymoon.jpg', 
    ...
    (4, 'Amp', 'Pinkstar', 'V7', '/src/assets/catalogue/products/amps/pinkstar-v7.jpg', 
    ...
    (5, 'Synth', 'Borg', 'MT20', '/src/assets/catalogue/products/synth/borg-mt20.jpg', 
    ...
    (5, 'Synth', 'Romand', 'Juny 70', '/src/assets/catalogue/products/synth/romand-juny70.jpg', 
    ...
    (5, 'Synth', 'Voog', 'Uzi 16', '/src/assets/catalogue/products/synth/Voog%20Uzi%2016.jpg', 
    ...
    (5, 'Synth', 'Masturia', 'Ivy 1236', '/src/assets/catalogue/products/synth/masturia-ivy-1236.jpg', 
    ...
    (5, 'Synth', 'D''Angelica', 'Movoder Disco 73', '/src/assets/catalogue/products/synth/d''angelica-movoder-disco-73.jpg', 
    ...
    (5, 'Synth', 'LoveNation', 'Vitto 6', '/src/assets/catalogue/products/synth/lovenation-vitto6.jpg', 
